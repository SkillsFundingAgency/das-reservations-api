Feature: Change of circumstances
...
Scenario: Change employer, non-levy to non-levy
	...
	| Account Id | Provider Id | Start Date | Created Date | Course Id | Status    | Is Levy Account |
	| 1          | 15214       | 2019-07-01 | 2019-01-01   | 1         | Confirmed | False           |
	And I want to change employer to 2
...
Scenario: Change employer, levy to levy
	...
	And I want to change employer to 20
	When I call change of circumstances
	Then I have the following reservations:
	| Account Id | Provider Id | Start Date | Created Date | Course Id | Status    | Is Levy Account |
	| 10         | 15214       | 2019-07-01 | 2019-01-01   | 1         | Confirmed | False           |
...
Scenario: Change provider
	...
	| Account Id | Provider Id | Start Date | Created Date | Course Id | Status    | Is Levy Account |
	| 1          | 15214       | 2019-07-01 | 2019-01-01   | 1         | Confirmed | False           |
	| 1          | 45665       | 2019-07-01 | today        | 1         | Changed   | False           |
