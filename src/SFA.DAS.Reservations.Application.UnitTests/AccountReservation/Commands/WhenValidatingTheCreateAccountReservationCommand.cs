...
namespace SFA.DAS.Reservations.Application.UnitTests.AccountReservation.Commands
{
    public class WhenValidatingTheCreateAccountReservationCommand
    {
        ...
        [TestCase("00000000-0000-0000-0000-000000000000", 0, null,null, false)]
        [TestCase("00000000-0000-0000-0000-000000000000", 1, "2019-08-08","TestName", false)]
        [TestCase("1ef0c978-9800-4da7-ad90-1345c71f20aa", 1, null,"TestName", false)]
        [TestCase("0bc21b1f-41e0-4470-94ea-b6fda27c4300", 0, "2019-08-08","TestName", false)]
        [TestCase("59294909-4549-4cb6-b849-25a32a18aa79", 1, "2019-08-08","", false)]
        [TestCase("59294909-4549-4cb6-b849-25a32a18aa79", 1, "2019-08-08","TestName", true)]
        public async Task Then_The_Command_Is_Validated_For_Each_Parameter(string id, long accountId, string date,string accountLegalEntityName, bool expected)
        {
            //Arrange
